...
h2 = figure(2);
subplot(3,1,1); 
plot(t, rpyVicon(:, 1),'r','LineWidth',1.5); hold on; 
plot(t, rpyAcc(:, 1),'g','LineWidth',1.5); plot(t,rpyVel(:, 1),'b','LineWidth', 1.5);
...
subplot(3,1,2); 
plot(t, rpyVicon(:, 2),'r','LineWidth',1.5); hold on; 
plot(t,rpyAcc(:, 2),'g','LineWidth',1.5); plot(t,rpyVel(:, 2),'b','LineWidth', 1.5);
xlim([t(1), t(end)]); xlabel('t/s'); ylabel('pitch/rad');
obj1= title('Plot of pitch-angle'); obj2 = legend('$Vicon$','$Acc$', '$Gyro$'); 
set(obj1,'Interpreter','Latex'); set(obj2,'Interpreter','Latex'); clear obj1 obj2;

subplot(3,1,3); 
plot(t, rpyVicon(:, 3),'r','LineWidth',1.5); hold on;
plot(t,rpyAcc(:, 3),'g','LineWidth',1.5); plot(t,rpyVel(:, 3),'b','LineWidth', 1.5);
